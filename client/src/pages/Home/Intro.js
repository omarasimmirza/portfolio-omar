...
function Intro({ darkMode }) {
  ...
  return (
    <div className="h-[90vh] flex flex-col items-start justify-center gap-8 pt-[10%] sm:pt-[20%] xs:pt-[30%] xxs:pt-[10%]">
      <div className="flex w-full mt-10">
        ...
        <div className="w-1/2">
          <img
            src={profile}
            className={`h-[400px] xs:h-full xxs:h-[70%] xxs:mt-[36%] sm:ml-[5%] ml-[40%] border-b-[4px] border-solid ${
